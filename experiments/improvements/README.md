...
| v09 | H-B: all-MiniLM-L6-v2 as an additive 4th head (killed by kill-switch, never built) | MiniLM-alone semantic: 0.59813 | not submitted | — | ❌ killed pre-build | never built (kill-switch failed) |
