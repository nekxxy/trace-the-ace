...
| v09 | H-B: all-MiniLM-L6-v2 (killed by kill-switch) then mean-pooled DistilBERT (passed kill-switch, killed by zero-weight blend check) as an additive 4th head | MiniLM-alone: 0.59813; DistilBERT-alone: 0.60025; best 4-way blend: 0.58742 (= noise vs current 0.58744) | not submitted | — | ❌ no ensemble value | never built (neither candidate helped) |
